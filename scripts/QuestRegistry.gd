...
static func _fallback_quests() -> Dictionary:
	return {
		...
		"post_reveal_witness_route": {
			...
			"owner": "Mira / Gus / Vendo / Mr. Byte / Cabinet 07 / Roxy / Pip",
			"location": "ArcadeHub, Cabinet Row, Prize Corner",
			"summary": "Speak with the witnesses after the reveal.",
			"details": "Pixel Haven remembers the protagonist in pieces. Speak with the witnesses after post-reveal roam unlocks.",
			"minigame": "None",
			"required": false,
			"starts_after": "post_reveal_roam_unlocked",
			"completion_dialogue": [
				{"speaker": "Quest", "text": "POST-REVEAL WITNESSES COMPLETE"},
				{"speaker": "Quest", "text": "Pixel Haven remembers you in pieces. Together, they almost make a person."},
			],

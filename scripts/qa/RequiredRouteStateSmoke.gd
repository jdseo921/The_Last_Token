...
func _init() -> void:
	...
	_check_state("09 Security Tape complete", "enter_staff_room", "Staff Room Terminal", "Overloaded", 9)
	...
	game_state.mark_conscience_encounter_seen("staff_corridor_approach")

...
const BACKGROUND_MASTER := "res://assets/art/minigames/rockbyte_duel/generated/rockbyte_duel_deluxe_background_master.png"
const SPRITE_SHEET := "res://assets/art/minigames/rockbyte_duel/generated/rockbyte_duel_deluxe_sprite_sheet.png"
const BACKGROUND_OUTPUT := "res://assets/art/minigames/rockbyte_duel/backgrounds/rockbyte_duel_deluxe.png"
const SPRITE_OUTPUTS := [
	{
		"path": "res://assets/art/minigames/rockbyte_duel/sprites/rockbyte_player_duelist.png",
		"canvas_size": Vector2i(40, 56),
		"max_size": Vector2i(36, 52),
	},
	{
		"path": "res://assets/art/minigames/rockbyte_duel/sprites/rockbyte_cabinet_07_duelist.png",
		"canvas_size": Vector2i(52, 68),
		"max_size": Vector2i(48, 64),
	},
	{
		"path": "res://assets/art/minigames/rockbyte_duel/sprites/rockbyte_data_rock_cyan.png",
		"canvas_size": Vector2i(18, 18),
		"max_size": Vector2i(16, 16),
	},
	{
		"path": "res://assets/art/minigames/rockbyte_duel/sprites/rockbyte_data_rock_magenta.png",
		"canvas_size": Vector2i(18, 18),
		"max_size": Vector2i(16, 16),
	},
]
...
func _build_background() -> bool:
	...
	if image.is_empty():
		push_error("Could not load Rockbyte background master: %s" % BACKGROUND_MASTER)
		return false
	image.resize(640, 440, Image.INTERPOLATE_NEAREST)
	var error := image.save_png(BACKGROUND_OUTPUT)
	if error != OK:
		push_error("Could not save Rockbyte background: %s" % error_string(error))
		return false
...
func _build_sprites() -> bool:
	...
	if sheet.is_empty():
		push_error("Could not load Rockbyte sprite sheet: %s" % SPRITE_SHEET)
		return false
	...
	for index in SPRITE_OUTPUTS.size():
		...
		var cell := sheet.get_region(Rect2i(cell_position, cell_size))
		var sprite := _fit_on_canvas(
			cell,
